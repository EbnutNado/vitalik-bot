...
# Явный мат и обсценная лексика для текста постов (не модерация «как в чате»)
BANNED_WORD_PATTERNS = [
    ...
    r"\bобоссышь\w*\b",
    r"\bобосран\w*\b",
    # --- англ. мат (без «чатовых» оскорблений) ---
    r"\bfuck\w*\b",
    r"\bfck\w*\b",
    r"\bfuk\w*\b",
    r"\bshit\w*\b",
